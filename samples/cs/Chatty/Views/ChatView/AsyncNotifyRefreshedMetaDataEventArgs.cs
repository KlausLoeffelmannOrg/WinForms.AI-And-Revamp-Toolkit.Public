...
public class AsyncNotifyRefreshedMetaDataEventArgs : EventArgs
{
    ...
    /// <remarks>
    ///  <para>
    ///   This constructor initializes the properties of the class with the values from the provided <see cref="ChatMetaData"/> object.
    ///  </para>
    /// </remarks>
    internal AsyncNotifyRefreshedMetaDataEventArgs(ChatMetaData? chatMetaData)
    {
        ChatTitle = chatMetaData?.ChatTitle;
        ChatSummary = chatMetaData?.ChatSummary;
        ChatKeywords = chatMetaData?.ChatKeywords;
        TokenCount = chatMetaData?.TokenCount ?? 0;
