...
public partial class FrmMain : Form
{
    ...
    public FrmMain()
    {
        ...
        _skMetaDataProcessor.SystemPrompt = " " +
    ...
    private void ConversationView_ConversationItemAdded(object? sender, CommunityToolkit.WinForms.Controls.Blazor.ConversationItemAddedEventArgs e)
    {
        ...
        string title = _chatView.ConversationView.ConversationTitle!;
        ...
        string json = _chatView.ConversationView.ToJson();
            ...
            updateTitleTask = TryUpdateTitleFromConversationAsync(textToSend)
                .ContinueWith(previousTask =>
                {
                    ...
                    if (previousTask.Result.hasAutoGeneratedTitle)
                    {
                        ...
                        _lblConversationTitle.Invoke(() => _lblConversationTitle.Text = previousTask.Result.autoGeneratedTitle);
    ...
    private void BtnStartNewChat_Click(object sender, EventArgs e)
    {
        ...
        _chatView.ConversationView.ConversationTitle = $"New chat on {DateTime.Now:dddd, MMM dd yyyy}";
